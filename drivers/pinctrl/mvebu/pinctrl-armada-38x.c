...
static struct mvebu_mpp_mode armada_38x_mpp_modes[] = {
	...
	MPP_MODE(22,
		 ...
		 MPP_VAR_FUNCTION(6, "nand",  "io0",        V_88F6810_PLUS)),
	MPP_MODE(23,
		 MPP_VAR_FUNCTION(0, "gpio",  NULL,         V_88F6810_PLUS),
		 MPP_VAR_FUNCTION(1, "spi0",  "sck",        V_88F6810_PLUS),
		 MPP_VAR_FUNCTION(5, "dev",   "ad2",        V_88F6810_PLUS),
		 MPP_VAR_FUNCTION(6, "nand",  "io2",        V_88F6810_PLUS)),
	MPP_MODE(24,
		 MPP_VAR_FUNCTION(0, "gpio",  NULL,         V_88F6810_PLUS),
	...
	MPP_MODE(25,
		 ...
		 MPP_VAR_FUNCTION(6, "nand",  "cen",        V_88F6810_PLUS)),
	MPP_MODE(26,
		 MPP_VAR_FUNCTION(0, "gpio",  NULL,         V_88F6810_PLUS),
	...
	MPP_MODE(28,
		 ...
		 MPP_VAR_FUNCTION(6, "nand",  "io5",        V_88F6810_PLUS)),
	MPP_MODE(29,
		 MPP_VAR_FUNCTION(0, "gpio",  NULL,         V_88F6810_PLUS),
	...
	MPP_MODE(30,
		 ...
		 MPP_VAR_FUNCTION(6, "nand",  "ren",        V_88F6810_PLUS)),
	MPP_MODE(31,
		 MPP_VAR_FUNCTION(0, "gpio",  NULL,         V_88F6810_PLUS),
	...
	MPP_MODE(38,
		 ...
		 MPP_VAR_FUNCTION(6, "nand",  "io4",        V_88F6810_PLUS)),
	MPP_MODE(39,
		 MPP_VAR_FUNCTION(0, "gpio",  NULL,         V_88F6810_PLUS),
	...
	MPP_MODE(40,
		 ...
		 MPP_VAR_FUNCTION(6, "nand",  "io6",        V_88F6810_PLUS)),
	MPP_MODE(41,
		 MPP_VAR_FUNCTION(0, "gpio",  NULL,         V_88F6810_PLUS),
	...
	MPP_MODE(42,
		 ...
		 MPP_VAR_FUNCTION(6, "nand",  "io7",        V_88F6810_PLUS)),
	MPP_MODE(43,
		 MPP_VAR_FUNCTION(0, "gpio",  NULL,         V_88F6810_PLUS),
